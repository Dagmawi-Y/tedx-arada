                ...
                <div className="flex flex-wrap justify-center gap-4 max-w-4xl mx-auto">
                    {sponsors.map((sponsor, idx) => (
                        <motion.div
                            ...
                            className="relative flex-1 min-w-[280px] aspect-2/1 flex items-center justify-center p-12 rounded-2xl transition-all duration-500 group overflow-hidden bg-white/[0.03] hover:bg-white/[0.08] border border-white/5 hover:border-white/10"
                        >
                            {/* Hover Glow Effect */}
                            ...
                            <img
                                src={sponsor.logo}
                                alt={sponsor.name}
                                className="relative z-10 max-w-full max-h-full object-contain transition-all duration-700 ease-out brightness-0 invert opacity-40 group-hover:brightness-100 group-hover:invert-0 group-hover:opacity-100 group-hover:scale-110"
                            />
                        </motion.div>
                    ))}
                </div>
