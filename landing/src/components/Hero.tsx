    ...
    return (
        ...
        >
                    ...
                    <AnimatePresence>
                        ...
                        >
                            ...
                            <img
                                ...
                                alt={`${event.name} - Addis Ababa, Ethiopia - Ideas worth spreading`}
            ...
            >
                ...
                >
                    <h1 className="sr-only">{event.seo.eventName}</h1>
                    ...
                    <p className="font-heading text-3xl md:text-5xl lg:text-6xl xl:text-7xl text-white font-bold leading-[1.1] tracking-tight uppercase">
                        {event.hero.headline} <br className="hidden md:block" />
                        <span className="text-transparent bg-clip-text bg-linear-to-r from-ted-red to-red-500 italic block mt-2 normal-case pb-2">{event.hero.headlineAccent}</span>
                    </p>
                </motion.div>
                ...
                >
                    <div className="text-center group flex flex-col items-center">
                        ...
                        <p className="text-sm md:text-base text-white font-sans font-medium transition-colors group-hover:text-ted-red">{event.hero.dateDisplay}</p>
                    </div>
                    ...
                    <div className="text-center group flex flex-col items-center">
                        ...
                        <p className="text-sm md:text-base text-white font-sans font-medium transition-colors group-hover:text-ted-red">{event.hero.venue}</p>
                    </div>
                </motion.div>
